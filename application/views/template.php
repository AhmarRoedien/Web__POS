...
<head>
    ...
    <title>Kios Yayasan As Sabiquun</title>
    <!-- Bootstrap Styles-->
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li>
                            <a href="<?php echo base_url() . 'auth/logout' ?>"><i class="fa fa-sign-out fa-fw"></i>
                                Logout</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url() . 'kategori' ?>"><i class="fa fa-desktop"></i> Kategori
                            Barang</a>
                    </li>
                    <li>
